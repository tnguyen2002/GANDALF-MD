...
SYSTEM = {
    ...
    'PretrainExpertAudioMNISTSystem': audio_systems.PretrainExpertAudioMNISTSystem,
    'PretrainViewmakerAudioMNISTSystem': audio_systems.PretrainViewmakerAudioMNISTSystem,
    # -- 
...
def run(args, gpu_device=None):
    ...
    wandb.init(project='audio', name=config.exp_name, config=config, sync_tensorboard=True)
    trainer = pl.Trainer(
